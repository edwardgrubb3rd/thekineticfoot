  ...
  res.json({
    ...
    "treatments": [
      ...
      },
      {
        ...
        "description": "Achilles tendonitis is an inflammation of the Achilles tendon. This inflammation is typically short-lived. Over time, if not resolved, the condition may progress to a degeneration of the tendon (Achilles tendonosis), in which the tendon loses its organized structure and is likely to develop microscopic tears."
      },
      {
      ...
      },
      {
        ...
        "id": "pttd",
        "description": "The posterior tibial tendon serves as one of the major supporting structures of the foot, helping it to function while walking. Posterior tibial tendon dysfunction (PTTD) is a condition caused by changes in the tendon, impairing its ability to support the arch. This results in flattening of the foot."
      },
      {
        "name": "Pre-dislocation Syndrome (Capsulitis)",
        "id": "capsulitis",
        "description": "Capsulitis is a condition in which these ligaments have become inflamed. Although capsulitis can also occur in the joints of the third or fourth toes, it most commonly affects the second toe. This inflammation causes considerable discomfort and, if left untreated, can eventually lead to a weakening of surrounding ligaments that can cause dislocation of the toe."
      },
      {
        "name": "Sesamoid Injuries",
        "id": "sesamoid",
        "description": "Sesamoid injuries can involve the bones, tendons and/or surrounding tissue in the joint. They are often associated with activities requiring increased pressure on the ball of the foot, such as running, basketball, football, golf, tennis and ballet. In addition, people with high arches are at risk for developing sesamoid problems."
      },
      {
        "name": "Calcaneal Apophysitis (Sever's Disease)",
        "id": "servers-disease",
        "description": "It typically affects children between the ages of 8 and 14 years old, because the heel bone (calcaneus) is not fully developed until at least age 14. Until then, new bone is forming at the growth plate (physis), a weak area located at the back of the heel. When there is too much repetitive stress on the growth plate, inflammation can develop."
      },
      {
